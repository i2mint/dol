...
Bases: [`DirCollection`](#dol.filesys.DirCollection), [`KvReader`](dol.base.md#dol.base.KvReader)
...
Bases: [`LocalFileDeleteMixin`](#dol.filesys.LocalFileDeleteMixin), [`FileBytesReader`](#dol.filesys.FileBytesReader), [`KvPersister`](dol.base.md#dol.base.KvPersister)
...
Bases: [`FileCollection`](#dol.filesys.FileCollection), [`KvReader`](dol.base.md#dol.base.KvReader)
...
Bases: [`Store`](dol.base.md#dol.base.Store)
