...
Bases: [`FlatReader`](dol.sources.md#dol.sources.FlatReader), [`ZipFilesReader`](#dol.zipfiledol.ZipFilesReader)
...
Bases: [`FileExistsError`](https://docs.python.org/3/builtins/exceptions.html#FileExistsError), [`OverWritesNotAllowedError`](dol.errors.md#dol.errors.OverWritesNotAllowedError)
...
Bases: [`PrefixRelativizationMixin`](dol.paths.md#dol.paths.PrefixRelativizationMixin), [`Store`](dol.base.md#dol.base.Store)
...
Bases: [`KvPersister`](dol.base.md#dol.base.KvPersister)
...
Bases: [`FileCollection`](dol.filesys.md#dol.filesys.FileCollection), [`KvReader`](dol.base.md#dol.base.KvReader)
...
Bases: [`KvReader`](dol.base.md#dol.base.KvReader)
