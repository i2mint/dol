...
Bases: [`AttrContainer`](#dol.sources.AttrContainer), [`KvPersister`](dol.base.md#dol.base.KvPersister)
...
Bases: [`FanoutReader`](#dol.sources.FanoutReader), [`KvPersister`](dol.base.md#dol.base.KvPersister)
...
This is useful as the `source` argument to [`dol.caching.mk_sourced_store()`](dol.caching.md#dol.caching.mk_sourced_store)
